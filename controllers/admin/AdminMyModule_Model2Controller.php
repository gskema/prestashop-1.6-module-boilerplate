...
/**
 * Class AdminMyModule_Model2Controller
 *
 * @property MyModule                  $module
 * @property MyModule_Model2 $object
 */
class AdminMyModule_Model2Controller extends ModuleAdminController
{
    /**
     * AdminMyModule_Model2Controller constructor.
     */
    public function __construct()
    {
        $this->className   = 'MyModule_Model2';
        $this->table       = 'mm_model2';

        // If not specified, will be constructed like this: 'id_'.$this->table
        $this->identifier = 'id_mm_model2';

        // Used when table has position field
        $this->position_identifier = 'id_mm_model2';
    ...
    protected function processUpdateOptions()
    {
        ...
        // Hook::exec('actionMyModule_Model2OptionsChanged');
    }
    ...
    public function ajaxProcessUpdatePositions()
    {
        ...
        $sql = new DbQuery();
        $sql->select('id_my_translatable_object_model');
        $sql->from('my_translatable_object_model');
        ...
        Hook::exec('actionMyModule_Model2PositionsChanged');
